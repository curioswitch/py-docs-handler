...
class TestService(Protocol):
    async def unary_call_with_all_different_parameter_types(self, request: testpb__pb2.ExtendedTestMessage, ctx: RequestContext) -> testpb__pb2.ExtendedTestMessage:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")


class TestServiceASGIApplication(ConnecpyASGIApplication):
    def __init__(self, service: TestService, *, interceptors: Iterable[Interceptor]=(), read_max_bytes: int | None = None):
        super().__init__(
            endpoints={
...
class TestServiceSync(Protocol):
    def unary_call_with_all_different_parameter_types(self, request: testpb__pb2.ExtendedTestMessage, ctx: RequestContext) -> testpb__pb2.ExtendedTestMessage:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")


class TestServiceWSGIApplication(ConnecpyWSGIApplication):
    def __init__(self, service: TestServiceSync, interceptors: Iterable[InterceptorSync]=(), read_max_bytes: int | None = None):
        super().__init__(
            endpoints={
