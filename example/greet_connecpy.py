...
class GreetService(Protocol):
    async def greet(self, request: greet__pb2.GreetingRequest, ctx: RequestContext) -> greet__pb2.GreetingResponse:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")


class GreetServiceASGIApplication(ConnecpyASGIApplication):
    def __init__(self, service: GreetService, *, interceptors: Iterable[Interceptor]=(), read_max_bytes: int | None = None):
        super().__init__(
            endpoints={
...
class GreetServiceSync(Protocol):
    def greet(self, request: greet__pb2.GreetingRequest, ctx: RequestContext) -> greet__pb2.GreetingResponse:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")


class GreetServiceWSGIApplication(ConnecpyWSGIApplication):
    def __init__(self, service: GreetServiceSync, interceptors: Iterable[InterceptorSync]=(), read_max_bytes: int | None = None):
        super().__init__(
            endpoints={
